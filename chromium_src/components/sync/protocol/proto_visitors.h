...
#define BRAVE_VISIT_NIGORI_SPECIFICS_ENCRYPT_VG_BODIES_ENCRYPT_VG_SPEND_STATUSES \
...
#undef BRAVE_VISIT_NIGORI_SPECIFICS_ENCRYPT_VG_BODIES_ENCRYPT_VG_SPEND_STATUSES
